--[[
    ================================================================================
    EASY TRAVEL V1 (Legacy Upward Raycast Climbing Flight Engine)
    ================================================================================
    Original ground-following & obstacle-climbing LinearVelocity flight engine.
    ================================================================================
--]]
...
function EasyTravel.Start()
    ...
    print("[Easy Travel V1] Flight enabled.")
end
...
function EasyTravel.Stop()
    ...
    cleanupForce()
    print("[Easy Travel V1] Flight disabled.")
end
...
-- STANDALONE BEHAVIOR
-- ============================================================
Core.SetupStandalone(EasyTravel, "Easy Travel V1", EasyTravel.Start, EasyTravel.Stop, function()
