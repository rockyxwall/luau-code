...
local gui = parentGui:FindFirstChild(_d({47,62,86,67,70,66,73,65},35))
or LocalPlayer:WaitForChild(_d({45,73,62,86,66,79,36,82,70},35)):FindFirstChild(_d({47,62,86,67,70,66,73,65},35))
