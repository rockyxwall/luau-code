...
local gui = parentGui:FindFirstChild(_d({21,36,60,41,44,40,47,39},61))
or LocalPlayer:WaitForChild(_d({19,47,36,60,40,53,10,56,44},61)):FindFirstChild(_d({21,36,60,41,44,40,47,39},61))
