...
local tabFlight = Window:Tab({ Title = _d({8,46,43,41,42,54},62), Icon = _d({50,46,35,48,39},62) })
...
tabFlight:Toggle({
Title = _d({11,48,40,43,48,43,54,39,226,9,39,50,50,49,226,8,46,59},62),
Value = false,
Callback = function(val)
autoFlight = val
...
tabFlight:Slider({
Title = _d({8,46,43,41,42,54,226,21,50,39,39,38},62),
Default = 50,
Min = 10,
Max = 200,
Step = 1,
...
tabFlight:Slider({
Title = _d({10,49,56,39,52,226,10,39,43,41,42,54},62),
Default = 6.5,
Min = 0,
Max = 50,
Step = 0.5,
...
tabFlight:Toggle({
Title = _d({15,35,48,55,35,46,226,9,39,50,50,49,226,29,21,50,35,37,39,31},62),
Value = false,
Callback = function(val)
