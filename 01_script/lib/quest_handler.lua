...
task.spawn(function()
print(_d({65,55,91,75,89,90,6,46,71,84,74,82,75,88,67,6,39,90,90,75,83,86,90,79,84,77,6,90,85,6,90,71,82,81,6,90,85,6,90,75,89,90,6,52,54,41,32},26), QuestHandler.TargetNPC)
...
QuestHandler.Running = false
print(_d({65,55,91,75,89,90,6,46,71,84,74,82,75,88,67,6,57,90,85,86,86,75,74,20},26))
end
Core.SetupStandalone(
QuestHandler,
_d({55,91,75,89,90,6,46,71,84,74,82,75,88},26),
QuestHandler.Start,
QuestHandler.Stop,
