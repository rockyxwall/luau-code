...
statsFolder = ReplicatedStorage:FindFirstChild(_d({41,74,55,74,73},42) .. LocalPlayer.Name)
if statsFolder then
peliValueObj = statsFolder:FindFirstChild(_d({38,59,66,63},42))
if not (peliValueObj and peliValueObj:IsA(_d({44,55,66,75,59,24,55,73,59},42))) then
local nested = statsFolder:FindFirstChild(_d({41,74,55,74,73},42))
peliValueObj = nested and nested:FindFirstChild(_d({38,59,66,63},42))
end
levelValueObj = statsFolder:FindFirstChild(_d({34,59,76,59,66},42))
if not (levelValueObj and levelValueObj:IsA(_d({44,55,66,75,59,24,55,73,59},42))) then
local nested = statsFolder:FindFirstChild(_d({41,74,55,74,73},42))
levelValueObj = nested and nested:FindFirstChild(_d({34,59,76,59,66},42))
end
staminaValueObj = statsFolder:FindFirstChild(_d({41,74,55,67,63,68,55},42))
else
peliValueObj = nil
levelValueObj = nil
staminaValueObj = nil
...
local hum = char and char:FindFirstChild(_d({30,75,67,55,68,69,63,58},42))
if hum then
...
print("[" .. tostring(name) .. _d({51,246,41,74,55,68,58,55,66,69,68,59,246,35,69,58,59,16,246,38,72,59,73,73,246,253},42) .. toggleKey.Name .. _d({253,246,74,69,246,74,69,61,61,66,59,4},42))
end
...
local Safeguard = {
Config = {
PrivateServerCode = _d({32,65,8,32,33,42,23,33,25,60},42),
TeleportLocation = _d({7,73,74,41,59,55},42)
}
}
local GPO_UNIVERSE_ID = 648454481
local BANNED_PLACES = {
[1730877806] = _d({28,63,72,73,74,246,41,59,55,246,30,69,67,59,73,57,72,59,59,68,246,5,246,35,55,63,68,246,35,59,68,75},42),
}
function Safeguard.JoinPrivateServer()
local code = Safeguard.Config.PrivateServerCode
if type(code) == _d({73,74,72,63,68,61},42) and code ~= "" then
print(string.format(_d({49,41,55,60,59,61,75,55,72,58,51,246,32,69,63,68,63,68,61,246,38,72,63,76,55,74,59,246,41,59,72,76,59,72,246,253,251,73,253,4,4,4},42), code))
task.spawn(function()
local rs = game:GetService(_d({40,59,70,66,63,57,55,74,59,58,41,74,69,72,55,61,59},42))
local reservedRemote = rs:WaitForChild(_d({27,76,59,68,74,73},42)):WaitForChild(_d({72,59,73,59,72,76,59,58},42))
task.spawn(function()
...
if v:IsA(_d({40,59,67,69,74,59,27,76,59,68,74},42)) and (v.Name == _d({40,59,67,69,74,59,27,76,59,68,74},42) or v.Name == _d({74,59,66,59},42) or v.Name == _d({42,59,66,59,70,69,72,74},42)) then
teleRemote = v
break
end
end
...
if teleRemote then
print(_d({49,41,55,60,59,61,75,55,72,58,51,246,28,63,72,63,68,61,246,74,59,66,59,70,69,72,74,246,72,59,67,69,74,59,16,246},42) .. teleRemote.Name)
teleRemote:FireServer(true)
else
warn(_d({49,41,55,60,59,61,75,55,72,58,51,246,25,69,75,66,58,246,68,69,74,246,60,63,68,58,246,40,59,67,69,74,59,27,76,59,68,74,246,63,68,246,68,63,66,4,246,38,72,63,68,74,63,68,61,246,55,66,66,246,40,59,67,69,74,59,27,76,59,68,74,73,246,63,68,246,68,63,66,16},42))
for _,v in next, getnilinstances() do
if v:IsA(_d({40,59,67,69,74,59,27,76,59,68,74},42)) then
print(_d({246,3,246,36,55,67,59,16},42), v.Name)
end
end
end
end)
...
warn(_d({49,41,55,60,59,61,75,55,72,58,51,246,45,72,69,68,61,246,61,55,67,59,246,75,68,63,76,59,72,73,59,247,246,41,57,72,63,70,74,246,63,73,246,69,68,66,79,246,60,69,72,246,29,38,37,4},42))
return false
end
if BANNED_PLACES[game.PlaceId] then
warn(_d({49,41,55,60,59,61,75,55,72,58,51,246,41,57,72,63,70,74,246,59,78,59,57,75,74,63,69,68,246,56,66,69,57,65,59,58,246,69,68,16,246},42) .. BANNED_PLACES[game.PlaceId])
if Safeguard.JoinPrivateServer() then
print(_d({49,41,55,60,59,61,75,55,72,58,51,246,42,59,66,59,70,69,72,74,63,68,61,246,74,69,246,38,72,63,76,55,74,59,246,41,59,72,76,59,72,4,4,4,246,38,66,59,55,73,59,246,77,55,63,74,4},42))
else
warn(_d({49,41,55,60,59,61,75,55,72,58,51,246,38,72,63,76,55,74,59,41,59,72,76,59,72,25,69,58,59,246,63,73,246,68,69,74,246,73,59,74,4,246,25,55,68,68,69,74,246,55,75,74,69,3,64,69,63,68,4},42))
end
return false
end
return true
...
if BANNED_PLACES[game.PlaceId] then
warn(string.format(_d({49,41,55,60,59,61,75,55,72,58,51,246,47,69,75,246,55,72,59,246,69,68,246,74,62,59,246,30,69,67,59,73,57,72,59,59,68,4,246,41,57,72,63,70,74,246,72,59,71,75,63,72,59,73,246,251,73,4},42), name or _d({55,246,73,70,59,57,63,60,63,57,246,70,66,55,57,59},42)))
if Safeguard.JoinPrivateServer() then
print(_d({49,41,55,60,59,61,75,55,72,58,51,246,42,59,66,59,70,69,72,74,63,68,61,246,74,69,246,38,72,63,76,55,74,59,246,41,59,72,76,59,72,4,4,4,246,38,66,59,55,73,59,246,77,55,63,74,4},42))
else
warn(_d({49,41,55,60,59,61,75,55,72,58,51,246,38,72,63,76,55,74,59,41,59,72,76,59,72,25,69,58,59,246,63,73,246,68,69,74,246,73,59,74,4,246,25,55,68,68,69,74,246,55,75,74,69,3,64,69,63,68,4},42))
...
warn(string.format(_d({49,41,55,60,59,61,75,55,72,58,51,246,45,72,69,68,61,246,70,66,55,57,59,247,246,40,59,71,75,63,72,59,58,16,246,251,73,246,254,251,58,255,2,246,25,75,72,72,59,68,74,16,246,251,58},42), name or _d({43,68,65,68,69,77,68},42), placeId, game.PlaceId))
return false
end
return Safeguard
end)()
...
return Core.Import(_d({6,7,3,61,70,69,5,66,63,56,5,73,55,60,59,61,75,55,72,58,4,66,75,55},42), _d({62,74,74,70,73,16,5,5,72,55,77,4,61,63,74,62,75,56,75,73,59,72,57,69,68,74,59,68,74,4,57,69,67,5,72,69,57,65,79,78,77,55,66,66,5,66,75,55,75,3,57,69,58,59,5,67,55,63,68,5,6,7,53,73,57,72,63,70,74,5,66,63,56,5,73,55,60,59,61,75,55,72,58,4,66,75,55},42))
end
return Core
end)()
if not Core then
...
if not Safeguard.RequirePlace(11424731604, _d({25,75,70,63,58,246,26,75,68,61,59,69,68},42)) then
return
end
enableBot()
end
...
CupidDungeon,
_d({25,75,70,63,58,246,26,75,68,61,59,69,68},42),
CupidDungeon.Start,
CupidDungeon.Stop,
...
Connections = {},
Config = {
SelectedBoss = _d({32,75,80,69,246,74,62,59,246,26,63,55,67,69,68,58,56,55,57,65},42),
UseE = true,
UseZ = true,
UseC = true,
UseR = true
...
if target then
if key == _d({30,63,74},42) then return target.CFrame
elseif key == _d({42,55,72,61,59,74},42) then return target
end
end
end
...
if not successHook then warn(_d({49,30,69,72,69,28,55,72,67,51,246,35,59,74,55,74,55,56,66,59,246,62,69,69,65,246,60,55,63,66,59,58,16,246},42) .. tostring(err)) end
end
...
print(_d({49,30,69,72,69,28,55,72,67,51,246,41,74,69,70,70,59,58,4},42))
end
function HoroFarm.Start()
if HoroFarm.Running then warn(_d({49,30,69,72,69,28,55,72,67,51,246,23,66,72,59,55,58,79,246,72,75,68,68,63,68,61,247},42)); return end
if not Safeguard then warn(_d({49,41,55,60,59,61,75,55,72,58,51,246,28,55,63,66,59,58,246,74,69,246,66,69,55,58,247},42)); return end
if not Safeguard.IsSafe() then return end
HoroFarm.Running = true
setupHook()
print(_d({49,30,69,72,69,28,55,72,67,51,246,41,74,55,72,74,59,58,246,74,55,72,61,59,74,63,68,61,16,246},42) .. HoroFarm.Config.SelectedBoss)
task.spawn(function()
...
print(_d({49,34,59,76,59,66,246,29,72,63,68,58,59,72,51,246,41,74,69,70,70,59,58,4},42))
end
function LevelGrinder.Start()
if LevelGrinder.Running then warn(_d({49,34,59,76,59,66,246,29,72,63,68,58,59,72,51,246,23,66,72,59,55,58,79,246,72,75,68,68,63,68,61,247},42)); return end
if not Safeguard then warn(_d({49,41,55,60,59,61,75,55,72,58,51,246,28,55,63,66,59,58,246,74,69,246,66,69,55,58,247},42)); return end
if not Safeguard.RequirePlace(3978370137, _d({28,63,72,73,74,246,41,59,55},42)) then return end
LevelGrinder.Running = true
task.spawn(function()
if not game:IsLoaded() then game.Loaded:Wait() end
local char = LocalPlayer.Character or LocalPlayer.CharacterAdded:Wait()
local hrp = char:WaitForChild(_d({30,75,67,55,68,69,63,58,40,69,69,74,38,55,72,74},42), 10)
local hum = char:WaitForChild(_d({30,75,67,55,68,69,63,58},42), 10)
local stats = ReplicatedStorage:WaitForChild(_d({41,74,55,74,73},42) .. LocalPlayer.Name, 30)
if stats then
stats:WaitForChild(_d({38,59,66,63},42), 10)
end
...
local hasRifle = LocalPlayer.Backpack:FindFirstChild(_d({40,63,60,66,59},42)) or (char and char:FindFirstChild(_d({40,63,60,66,59},42)))
if hasRifle then break end
local peli = Core.GetPeli()
print(_d({49,34,59,76,59,66,246,29,72,63,68,58,59,72,51,246,25,75,72,72,59,68,74,246,38,59,66,63,246,57,62,59,57,65,16},42), peli)
local inTown = hrp and hrp.Position.X >= -889 and hrp.Position.X <= -156 and hrp.Position.Z >= -3706 and hrp.Position.Z <= -3087
if not inTown then
warn(_d({49,34,59,76,59,66,246,29,72,63,68,58,59,72,51,246,36,69,74,246,55,74,246,42,69,77,68,246,69,60,246,24,59,61,63,68,68,63,68,61,73,4,246,38,66,59,55,73,59,246,74,72,55,76,59,66,246,74,62,59,72,59,246,74,69,246,60,55,72,67,246,57,62,59,73,74,73,246,77,62,63,66,59,246,77,55,63,74,63,68,61,246,60,69,72,246,40,63,60,66,59,4},42))
task.wait(2)
continue
end
...
_G.DisableStandalone = true
ChestFarmer = Core.Import(_d({6,7,3,61,70,69,5,66,63,56,5,57,62,59,73,74,53,60,55,72,67,59,72,4,66,75,55},42), _d({62,74,74,70,73,16,5,5,72,55,77,4,61,63,74,62,75,56,75,73,59,72,57,69,68,74,59,68,74,4,57,69,67,5,72,69,57,65,79,78,77,55,66,66,5,66,75,55,75,3,57,69,58,59,5,67,55,63,68,5,6,7,53,73,57,72,63,70,74,5,66,63,56,5,57,62,59,73,74,53,60,55,72,67,59,72,4,66,75,55},42))
_G.DisableStandalone = old
end
if ChestFarmer then
if peli < 300 then
print(_d({49,34,59,76,59,66,246,29,72,63,68,58,59,72,51,246,28,55,72,67,63,68,61,246,57,62,59,73,74,73,246,75,68,74,63,66,246,9,6,6,246,38,59,66,63,4,4,4,246,254,25,75,72,72,59,68,74,16,246},42) .. tostring(peli) .. ")")
ChestFarmer.FarmUntilPeli(300, function()
local s = ReplicatedStorage:FindFirstChild(_d({41,74,55,74,73},42) .. LocalPlayer.Name)
local pObj = s and s:FindFirstChild(_d({38,59,66,63},42))
return pObj and (tonumber(pObj.Value) or 0) or 0
end, function()
local c = LocalPlayer.Character
return LevelGrinder.Running and not (LocalPlayer.Backpack:FindFirstChild(_d({40,63,60,66,59},42)) or (c and c:FindFirstChild(_d({40,63,60,66,59},42))))
end)
else
if not EasyTravel then
local old = _G.DisableStandalone
_G.DisableStandalone = true
EasyTravel = Core.Import(_d({6,7,3,61,70,69,5,66,63,56,5,59,55,73,79,53,74,72,55,76,59,66,4,66,75,55},42), _d({62,74,74,70,73,16,5,5,72,55,77,4,61,63,74,62,75,56,75,73,59,72,57,69,68,74,59,68,74,4,57,69,67,5,72,69,57,65,79,78,77,55,66,66,5,66,75,55,75,3,57,69,58,59,5,67,55,63,68,5,6,7,53,73,57,72,63,70,74,5,66,63,56,5,59,55,73,79,53,74,72,55,76,59,66,4,66,75,55},42))
_G.DisableStandalone = old
if EasyTravel and EasyTravel.Cleanup then
pcall(EasyTravel.Cleanup)
end
end
local buyables = workspace:FindFirstChild(_d({24,75,79,55,56,66,59,31,74,59,67,73},42))
local shopItem = buyables and buyables:FindFirstChild(_d({40,63,60,66,59},42))
local shopPart = shopItem and shopItem:FindFirstChild(_d({41,62,69,70,38,55,72,74},42))
if EasyTravel and shopPart and hrp then
print(_d({49,34,59,76,59,66,246,29,72,63,68,58,59,72,51,246,42,72,55,76,59,66,63,68,61,246,74,69,246,40,63,60,66,59,246,73,62,69,70,246,76,63,55,246,27,55,73,79,42,72,55,76,59,66,4,4,4},42))
local nocollide = game:GetService(_d({40,75,68,41,59,72,76,63,57,59},42)).Stepped:Connect(function()
local c = LocalPlayer.Character
if c then
...
task.wait(0.5)
local shopEvent = ReplicatedStorage:FindFirstChild(_d({27,76,59,68,74,73},42)) and ReplicatedStorage.Events:FindFirstChild(_d({41,62,69,70},42))
if shopEvent and shopEvent:IsA(_d({40,59,67,69,74,59,28,75,68,57,74,63,69,68},42)) then
pcall(function()
shopEvent:InvokeServer(shopItem, 1)
end)
end
task.wait(1)
print(_d({49,34,59,76,59,66,246,29,72,63,68,58,59,72,51,246,27,71,75,63,70,70,63,68,61,246,40,63,60,66,59,4,4,4},42))
local args = {
[1] = _d({59,71,75,63,70},42),
[2] = _d({40,63,60,66,59},42)
}
local toolsEvent = ReplicatedStorage:FindFirstChild(_d({27,76,59,68,74,73},42)) and ReplicatedStorage.Events:FindFirstChild(_d({42,69,69,66,73},42))
if toolsEvent and toolsEvent:IsA(_d({40,59,67,69,74,59,28,75,68,57,74,63,69,68},42)) then
pcall(function()
...
local hum = char and char:FindFirstChild(_d({30,75,67,55,68,69,63,58},42))
local hrp = char and char:FindFirstChild(_d({30,75,67,55,68,69,63,58,40,69,69,74,38,55,72,74},42))
local rifle = LocalPlayer.Backpack:FindFirstChild(_d({40,63,60,66,59},42))
if rifle and hum then hum:EquipTool(rifle) end
print(_d({49,34,59,76,59,66,246,29,72,63,68,58,59,72,51,246,28,66,79,63,68,61,246,74,69,246,28,63,73,62,67,55,68,246,25,55,76,59,4,4,4},42))
if not EasyTravel then
local old = _G.DisableStandalone
_G.DisableStandalone = true
EasyTravel = Core.Import(_d({6,7,3,61,70,69,5,66,63,56,5,59,55,73,79,53,74,72,55,76,59,66,4,66,75,55},42), _d({62,74,74,70,73,16,5,5,72,55,77,4,61,63,74,62,75,56,75,73,59,72,57,69,68,74,59,68,74,4,57,69,67,5,72,69,57,65,79,78,77,55,66,66,5,66,75,55,75,3,57,69,58,59,5,67,55,63,68,5,6,7,53,73,57,72,63,70,74,5,66,63,56,5,59,55,73,79,53,74,72,55,76,59,66,4,66,75,55},42))
...
if wasAtShop then
print(_d({49,34,59,76,59,66,246,29,72,63,68,58,59,72,51,246,27,73,57,55,70,63,68,61,246,73,62,69,70,246,63,68,74,59,72,63,69,72,246,56,79,246,60,66,79,63,68,61,246,73,74,72,55,63,61,62,74,246,75,70,4,4,4},42))
local nocollide = game:GetService(_d({40,75,68,41,59,72,76,63,57,59},42)).Stepped:Connect(function()
local c = LocalPlayer.Character
if c then
for _, part in ipairs(c:GetDescendants()) do
...
if inCave then
local FishmanMaze = Core.Import(_d({6,7,3,61,70,69,5,66,63,56,5,60,63,73,62,67,55,68,53,67,55,80,59,4,66,75,55},42), _d({62,74,74,70,73,16,5,5,72,55,77,4,61,63,74,62,75,56,75,73,59,72,57,69,68,74,59,68,74,4,57,69,67,5,72,69,57,65,79,78,77,55,66,66,5,66,75,55,75,3,57,69,58,59,5,67,55,63,68,5,6,7,53,73,57,72,63,70,74,5,66,63,56,5,60,63,73,62,67,55,68,53,67,55,80,59,4,66,75,55},42))
if FishmanMaze then
pcall(function()
FishmanMaze.Travel(hrp, function() return LevelGrinder.Running end)
end)
else
warn(_d({49,34,59,76,59,66,246,29,72,63,68,58,59,72,51,246,28,55,63,66,59,58,246,74,69,246,63,67,70,69,72,74,246,28,63,73,62,67,55,68,35,55,80,59,246,66,63,56,72,55,72,79,247},42))
end
else
warn(_d({49,34,59,76,59,66,246,29,72,63,68,58,59,72,51,246,37,75,74,73,63,58,59,246,28,63,73,62,67,55,68,246,25,55,76,59,246,56,69,75,68,58,73,2,246,73,65,63,70,70,63,68,61,246,67,55,80,59,4},42))
end
end
LevelGrinder.Stop()
end)
...
Core.SetupStandalone(
LevelGrinder,
_d({34,59,76,59,66,246,29,72,63,68,58,59,72},42),
LevelGrinder.Start,
LevelGrinder.Stop,
...
return char, char:FindFirstChildWhichIsA(_d({30,75,67,55,68,69,63,58},42)), char:FindFirstChild(_d({30,75,67,55,68,69,63,58,40,69,69,74,38,55,72,74},42))
end
local function getOrCreateForce(root)
local att = root:FindFirstChild(_d({53,53,27,55,73,79,42,72,55,76,59,66,23,74,74},42)) or Instance.new(_d({23,74,74,55,57,62,67,59,68,74},42))
att.Name = _d({53,53,27,55,73,79,42,72,55,76,59,66,23,74,74},42)
att.Parent = root
local force = root:FindFirstChild(_d({53,53,27,55,73,79,42,72,55,76,59,66,28,69,72,57,59},42))
if not force then
force = Instance.new(_d({34,63,68,59,55,72,44,59,66,69,57,63,74,79},42))
force.Name = _d({53,53,27,55,73,79,42,72,55,76,59,66,28,69,72,57,59},42)
force.Attachment0 = att
force.VelocityConstraintMode = Enum.VelocityConstraintMode.Vector
force.RelativeTo = Enum.ActuatorRelativeTo.World
...
if root then
local force = root:FindFirstChild(_d({53,53,27,55,73,79,42,72,55,76,59,66,28,69,72,57,59},42))
local att = root:FindFirstChild(_d({53,53,27,55,73,79,42,72,55,76,59,66,23,74,74},42))
if force then force:Destroy() end
if att then att:Destroy() end
end
end
...
local hitCave = false
local cave = Workspace.Islands:FindFirstChild(_d({28,63,73,62,67,55,68,246,25,55,76,59},42))
...
print(_d({49,27,55,73,79,246,42,72,55,76,59,66,51,246,28,66,63,61,62,74,246,59,68,55,56,66,59,58,4},42))
end
function EasyTravel.Stop()
EasyTravel.Enabled = false
if loopConnection then loopConnection:Disconnect(); loopConnection = nil end
cleanupForce()
print(_d({49,27,55,73,79,246,42,72,55,76,59,66,51,246,28,66,63,61,62,74,246,58,63,73,55,56,66,59,58,4},42))
end
...
Core.SetupStandalone(
EasyTravel,
_d({27,55,73,79,246,42,72,55,76,59,66},42),
EasyTravel.Start,
EasyTravel.Stop,
...
local playerGui = LocalPlayer:WaitForChild(_d({38,66,55,79,59,72,29,75,63},42), 10)
if not playerGui then return end
local oldUI = playerGui:FindFirstChild(_d({29,38,37,34,55,75,68,57,62,59,72,43,31},42))
if oldUI then oldUI:Destroy() end
local screenGui = Instance.new(_d({41,57,72,59,59,68,29,75,63},42))
screenGui.Name = _d({29,38,37,34,55,75,68,57,62,59,72,43,31},42)
screenGui.ResetOnSpawn = false
screenGui.Parent = playerGui
...
local corner = Instance.new(_d({43,31,25,69,72,68,59,72},42))
...
title.TextXAlignment = Enum.TextXAlignment.Left
title.Text = _d({198,117,98,98,246,29,38,37,246,30,75,56,246,34,55,75,68,57,62,59,72},42)
title.Parent = main
...
local status = Instance.new(_d({42,59,78,74,34,55,56,59,66},42))
...
status.Text = _d({25,62,69,69,73,59,246,55,246,56,69,74,246,69,72,246,75,74,63,66,63,74,79,246,74,69,246,72,75,68,16},42)
status.Parent = main
local buttonCount = 0
...
btn.Text = _d({246,246},42) .. text
btn.TextXAlignment = Enum.TextXAlignment.Left
btn.Parent = main
local btnCorner = Instance.new(_d({43,31,25,69,72,68,59,72},42))
btnCorner.CornerRadius = UDim.new(0, 6)
btnCorner.Parent = btn
local btnStroke = Instance.new(_d({43,31,41,74,72,69,65,59},42))
btnStroke.Color = Color3.fromRGB(48, 52, 68)
btnStroke.Thickness = 1
btnStroke.Parent = btn
local descLabel = Instance.new(_d({42,59,78,74,34,55,56,59,66},42))
...
CreateLaunchButton(_d({25,75,70,63,58,246,26,75,68,61,59,69,68,246,28,55,72,67},42), _d({23,75,74,69,67,55,74,59,246,57,75,70,63,58,246,58,75,68,61,59,69,68,73,246,252,246,56,69,73,73,246,57,79,57,66,59,73},42), loadCupidDungeon)
CreateLaunchButton(_d({30,69,72,69,246,24,69,73,73,246,28,55,72,67,246,254,41,63,66,59,68,74,246,23,63,67,255},42), _d({23,75,74,69,60,55,72,67,246,69,76,59,72,77,69,72,66,58,246,56,69,73,73,59,73,246,75,73,63,68,61,246,30,69,72,69,246,60,72,75,63,74,73},42), loadHoroBossFarm)
CreateLaunchButton(_d({34,59,76,59,66,246,252,246,35,69,56,246,29,72,63,68,58,59,72},42), _d({23,75,74,69,3,66,59,76,59,66,246,55,68,58,246,60,55,72,67,246,66,69,57,55,66,246,36,38,25,246,67,69,56,73},42), loadLevelGrinder)
CreateLaunchButton(_d({27,55,73,79,246,42,72,55,76,59,66,246,254,38,246,42,69,61,61,66,59,255},42), _d({45,23,41,26,246,28,66,63,61,62,74,246,77,63,74,62,246,61,72,69,75,68,58,246,60,69,66,66,69,77,246,252,246,77,55,66,66,246,57,66,63,67,56,63,68,61},42), loadNavigationLab)
CreateLaunchButton(_d({38,62,79,73,63,57,73,246,37,76,59,72,77,69,72,66,58,246,42,59,73,74,59,72},42), _d({42,59,73,74,246,57,69,67,56,55,74,246,62,69,76,59,72,2,246,61,59,70,70,69,246,252,246,58,69,58,61,59,246,62,59,63,61,62,74,73},42), loadOverworldTester)
end
task.spawn(CreateLauncherUI)
print(_d({49,29,38,37,246,30,75,56,51,246,34,55,75,68,57,62,59,72,246,43,31,246,63,68,63,74,63,55,66,63,80,59,58,4},42))
end)()