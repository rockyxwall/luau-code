...
pcall(function()
game:GetService(_d({40,59,70,66,63,57,55,74,59,58,41,74,69,72,55,61,59},42)):WaitForChild(_d({27,76,59,68,74,73},42)):WaitForChild(_d({42,69,69,66,73},42)):InvokeServer(unpack(args))
end)
task.wait(1)
end
end
