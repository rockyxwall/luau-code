...
if hasRifle() then
print("[Gepo Grinder] Rifle already owned.")
...
print("[Gepo Grinder] Waiting for Rifle to replicate to Backpack...")
...
warn("[Gepo Grinder] Rifle was purchased but did not appear in Backpack/Character within 10 seconds.")
...
cleanup("Rifle purchased and equipped")
end)
if not ok then
