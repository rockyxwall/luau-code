...
unloadGui = Instance.new("ScreenGui")
unloadGui.Name = "EasyTravelUnloadUI"
...
button.Text = "Unload Easy Travel"
...
print("[Easy Travel] Completely unloaded and cleaned up old script state.")
end
