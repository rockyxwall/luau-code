...
warn(_d({38,30,44,49,48,25,44,65,52,50,44,63,58,61,40,235,24,52,62,62,52,57,50,235,46,51,44,61,44,46,63,48,61,235,46,58,56,59,58,57,48,57,63,62,249},53))
return
end
...
SafeNavigator.IsNavigating = false
if onComplete and type(onComplete) == _d({49,64,57,46,63,52,58,57},53) then
onComplete()
end
end)
end
