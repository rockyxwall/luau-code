...
if statsFolder then
local lvl = statsFolder:FindFirstChild("Stats_d({240,231,40,53,43,231,58,59,40,59,58,13,54,51,43,44,57,245,26,59,40,59,58,1,13,48,53,43,13,48,57,58,59,10,47,48,51,43,239},57)Level") and statsFolder.Stats.Level.Value or 1
local peli = statsFolder:FindFirstChild("Stats_d({240,231,40,53,43,231,58,59,40,59,58,13,54,51,43,44,57,245,26,59,40,59,58,1,13,48,53,43,13,48,57,58,59,10,47,48,51,43,239},57)Peli") and statsFolder.Stats.Peli.Value or 0
local quest = statsFolder:FindFirstChild("Quest_d({240,231,40,53,43,231,58,59,40,59,58,13,54,51,43,44,57,245,24,60,44,58,59,1,13,48,53,43,13,48,57,58,59,10,47,48,51,43,239},57)CurrentQuest_d({240,231,40,53,43,231,58,59,40,59,58,13,54,51,43,44,57,245,24,60,44,58,59,245,10,60,57,57,44,53,59,24,60,44,58,59,245,29,40,51,60,44,231,54,57,231},57)None"
...
local hasRifle = LocalPlayer.Backpack:FindFirstChild("Rifle_d({240,231,54,57,231,19,54,42,40,51,23,51,40,64,44,57,245,10,47,40,57,40,42,59,44,57,1,13,48,53,43,13,48,57,58,59,10,47,48,51,43,239},57)Rifle")
...
targetMob = _d({9,40,53,43,48,59,231,9,54,58,58},57)
if quest == "None" then
acceptQuest("Ronny")
return
end
