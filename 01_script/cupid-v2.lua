...
task.wait(5)
debug(_d({29,39,47,58,47,52,45,230,44,53,56,230,255,251,235,230,14,22,230,40,43,44,53,56,43,230,51,53,60,47,52,45,230,58,53,230,52,43,62,58,230,57,58,39,45,43},58))
local hum = getHumanoid()
if hum then
