...
task.wait(5)
debug(_d({24,34,42,53,42,47,40,225,39,48,51,225,250,246,230,225,9,17,225,35,38,39,48,51,38,225,46,48,55,42,47,40,225,53,48,225,47,38,57,53,225,52,53,34,40,38},63))
local hum = getHumanoid()
if hum then
