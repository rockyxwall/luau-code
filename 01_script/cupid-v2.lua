...
task.wait(5)
debug(_d({71,81,89,100,89,94,87,16,86,95,98,16,41,37,21,16,56,64,16,82,85,86,95,98,85,16,93,95,102,89,94,87,16,100,95,16,94,85,104,100,16,99,100,81,87,85},16))
local hum = getHumanoid()
if hum then
