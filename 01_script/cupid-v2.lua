...
task.wait(5)
debug(_d({37,47,55,66,55,60,53,238,52,61,64,238,7,3,243,238,22,30,238,48,51,52,61,64,51,238,59,61,68,55,60,53,238,66,61,238,60,51,70,66,238,65,66,47,53,51},50))
local hum = getHumanoid()
if hum then
