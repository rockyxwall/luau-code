...
task.wait(5)
debug(_d({68,78,86,97,86,91,84,13,83,92,95,13,38,34,18,13,53,61,13,79,82,83,92,95,82,13,90,92,99,86,91,84,13,97,92,13,91,82,101,97,13,96,97,78,84,82},19))
local hum = getHumanoid()
if hum then
