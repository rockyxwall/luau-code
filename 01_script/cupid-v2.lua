...
task.wait(5)
debug(_d({53,63,71,82,71,76,69,254,68,77,80,254,23,19,3,254,38,46,254,64,67,68,77,80,67,254,75,77,84,71,76,69,254,82,77,254,76,67,86,82,254,81,82,63,69,67},34))
local hum = getHumanoid()
if hum then
