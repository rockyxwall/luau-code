...
if not Safeguard.RequirePlace(11424731604, _d({42,92,87,80,75,7,43,92,85,78,76,86,85},25)) then
return
end
enableBot()
end
...
debug(_d({58,91,72,85,75,72,83,86,85,76,7,52,86,75,76,33,7,72,92,91,86,20,90,91,72,89,91,80,85,78,7,15,87,89,76,90,90,7,68,7,91,86,7,91,86,78,78,83,76,16},25))
end
return CupidDungeon
end)()