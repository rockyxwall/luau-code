...
debug(_d({46,74,63,87,67,80,254,66,71,67,66,255,254,49,82,77,78,78,71,76,69,254,64,77,82,12},34))
disableBot()
return
end
...
debug(_d({46,74,63,87,67,80,254,71,81,254,82,77,77,254,68,63,80,254,68,80,77,75,254,82,63,80,69,67,82,254,6,28,16,14,14,14,254,81,82,83,66,81,7,12,254,42,71,73,67,74,87,254,80,67,81,78,63,85,76,67,66,254,63,82,254,74,77,64,64,87,12,254,49,82,77,78,78,71,76,69,254,64,77,82,12},34))
disableBot()
return
end
...
debug(_d({50,77,77,73,254,66,63,75,63,69,67,254,85,70,71,74,67,254,85,63,74,73,71,76,69,254,82,77,254,78,77,71,76,82,255,254,49,82,77,78,78,71,76,69,254,85,63,74,73,254,82,77,254,67,76,69,63,69,67,12},34))
break
end
...
debug(_d({49,82,83,65,73,254,66,83,80,71,76,69,254,85,63,74,73,10,254,72,83,75,78,71,76,69,255},34))
stuckTicks += 1
VIM:SendKeyEvent(true, Enum.KeyCode.Space, false, game)
task.wait(0.05)
VIM:SendKeyEvent(false, Enum.KeyCode.Space, false, game)
if stuckTicks > 1 then
debug(_d({49,82,71,74,74,254,81,82,83,65,73,10,254,82,80,71,69,69,67,80,71,76,69,254,37,67,78,78,77,255},34))
task.wait(0.05)
VIM:SendKeyEvent(true, Enum.KeyCode.Space, false, game)
task.wait(0.05)
VIM:SendKeyEvent(false, Enum.KeyCode.Space, false, game)
...
task.wait(5)
debug(_d({53,63,71,82,71,76,69,254,68,77,80},34), targetHP * 100, _d({3,254,38,46,254,64,67,68,77,80,67,254,75,77,84,71,76,69,254,82,77,254,76,67,86,82,254,81,82,63,69,67},34))
local hum = getHumanoid()
if hum then
...
debug(_d({43,77,84,71,76,69,254,82,77,254,42,67,77},34))
equipSwordOrMelee()
...
debug(_d({42,67,77,254,81,82,63,80,82,67,66,254,64,74,77,65,73,11,64,80,67,63,73,67,80,254,75,71,66,11,64,74,77,65,73,255,254,35,84,63,66,71,76,69,12,12,12},34))
break
end
task.wait(0.1)
holdTime += 0.1
...
local hpTarget = (stage == _d({49,82,63,69,67,17,32},34)) and 0.40 or 0.95
clearStage(stage, hpTarget)
end
if not enabled then return end
debug(_d({43,77,84,71,76,69,254,82,77,254,63,80,80,77,85,254,68,74,87,11,66,77,85,76,254,63,80,67,63,254,6,33,83,78,71,66,254,48,63,71,76,7},34))
walkToPoint(COORDS.ArrowFlyDown, 30, true)
debug(_d({34,77,66,69,71,76,69,254,63,80,80,77,85,254,80,63,71,76,254,71,76,254,63,254,81,79,83,63,80,67},34))
local elapsed = 0
...
if not Safeguard.RequirePlace(11424731604, _d({33,83,78,71,66,254,34,83,76,69,67,77,76},34)) then
return
end
enableBot()
end
...
CupidDungeon,
_d({33,83,78,71,66,254,34,83,76,69,67,77,76},34),
CupidDungeon.Start,
CupidDungeon.Stop,
