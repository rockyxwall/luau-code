...
warn(_d({46,31,56,73,56,63,243,26,69,60,65,55,56,69,48,243,20,63,69,56,52,55,76,243,69,72,65,65,60,65,58,244},45))
return
end
...
if not Safeguard.RequirePlace(3978370137, _d({25,60,69,70,71,243,38,56,52},45)) then
return
end
...
_d({3,4,0,58,67,66,2,63,60,53,2,54,59,56,70,71,50,57,52,69,64,56,69,1,63,72,52},45),
_d({59,71,71,67,70,13,2,2,69,52,74,1,58,60,71,59,72,53,72,70,56,69,54,66,65,71,56,65,71,1,54,66,64,2,69,66,54,62,76,75,74,52,63,63,2,63,72,52,72,0,54,66,55,56,2,64,52,60,65,2,3,4,50,70,54,69,60,67,71,2,63,60,53,2,54,59,56,70,71,50,57,52,69,64,56,69,1,63,72,52},45)
)
...
and not (LocalPlayer.Backpack:FindFirstChild(_d({37,60,57,63,56},45)) or (c and c:FindFirstChild(_d({37,60,57,63,56},45))))
end)
else
...
_d({3,4,0,58,67,66,2,63,60,53,2,56,52,70,76,50,71,69,52,73,56,63,1,63,72,52},45),
_d({59,71,71,67,70,13,2,2,69,52,74,1,58,60,71,59,72,53,72,70,56,69,54,66,65,71,56,65,71,1,54,66,64,2,69,66,54,62,76,75,74,52,63,63,2,63,72,52,72,0,54,66,55,56,2,64,52,60,65,2,3,4,50,70,54,69,60,67,71,2,63,60,53,2,56,52,70,76,50,71,69,52,73,56,63,1,63,72,52},45)
)
_G.DisableStandalone = old
...
task.wait(0.5)
local shopEvent = ReplicatedStorage:FindFirstChild(_d({24,73,56,65,71,70},45))
and ReplicatedStorage.Events:FindFirstChild(_d({38,59,66,67},45))
...
local toolsEvent = ReplicatedStorage:FindFirstChild(_d({24,73,56,65,71,70},45))
and ReplicatedStorage.Events:FindFirstChild(_d({39,66,66,63,70},45))
...
_d({3,4,0,58,67,66,2,63,60,53,2,57,60,70,59,64,52,65,50,64,52,77,56,1,63,72,52},45),
_d({59,71,71,67,70,13,2,2,69,52,74,1,58,60,71,59,72,53,72,70,56,69,54,66,65,71,56,65,71,1,54,66,64,2,69,66,54,62,76,75,74,52,63,63,2,63,72,52,72,0,54,66,55,56,2,64,52,60,65,2,3,4,50,70,54,69,60,67,71,2,63,60,53,2,57,60,70,59,64,52,65,50,64,52,77,56,1,63,72,52},45)
)
if FishmanMaze then
pcall(function()
...
Core.SetupStandalone(LevelGrinder, _d({31,56,73,56,63,243,26,69,60,65,55,56,69},45), LevelGrinder.Start, LevelGrinder.Stop, function()
return LevelGrinder.Running
end)
return LevelGrinder
end)()