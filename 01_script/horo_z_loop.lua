...
local JUZO_NON_AGRO = Vector3.new(1755.619263, 106.669167, -11010.874023)
...
print(_d({54,35,74,77,74,251,53,8,33,60,77,72,56,251,50,60,71,70,68,73,66,251,79,74,21},37), pos)
unlockCamera()
local ok, err = pcall(function()
VIM:SendKeyEvent(true, Enum.KeyCode.W, false, game)
VIM:SendKeyEvent(true, Enum.KeyCode.D, false, game)
end)
if not ok then warn(_d({54,35,74,77,74,251,53,8,33,60,77,72,56,251,82,60,71,70,47,74,43,74,68,73,79,251,70,64,84,78,251,63,74,82,73,251,64,77,77,74,77,21},37), err) end
local startT = tick()
...
if dist < 3 then
print(_d({54,35,74,77,74,251,53,8,33,60,77,72,56,251,28,77,77,68,81,64,63,251,60,79,251,63,64,78,79,68,73,60,79,68,74,73},37))
break
end
pcall(function()
...
task.wait(1)
if autoZLoop then
if selectedBoss == _d({37,80,85,74,251,79,67,64,251,31,68,60,72,74,73,63,61,60,62,70},37) then
if not isOnJuzoAxis() then
print(_d({54,35,74,77,74,251,53,8,33,60,77,72,56,251,46,64,71,64,62,79,64,63,251,37,80,85,74,251,61,80,79,251,75,71,60,84,64,77,251,68,78,251,73,74,79,251,74,73,251,79,67,64,251,62,60,81,64,251,60,83,68,78,9,251,52,251,62,74,74,77,63,68,73,60,79,64,251,72,80,78,79,251,61,64,251,12,11,11,8,12,12,13,251,60,73,63,251,73,64,60,77,251,79,67,64,251,62,60,81,64,9,251,50,60,68,79,68,73,66,9,9,9},37))
unlockCamera()
task.wait(5)
else
...
task.wait(0.05)
VIM:SendKeyEvent(false, Enum.KeyCode.Z, false, game)
print(_d({54,35,74,77,74,251,53,8,33,60,77,72,56,251,33,68,77,64,63,251,53,251,60,79,251,37,80,85,74,251,3,60,66,77,74,251,77,60,73,66,64,4},37))
else
warn(_d({54,35,74,77,74,251,53,8,33,60,77,72,56,251,33,60,68,71,64,63,251,79,74,251,75,77,74,69,64,62,79,251,37,80,85,74,251,79,74,251,81,68,64,82,75,74,77,79,9},37))
end
unlockCamera()
end
walkToPoint(JUZO_NON_AGRO, 15)
