...
Name = _d({20,59,62,59,236,20,59,62,59,236,38,249,18,45,62,57},52),
...
local selectedBoss = _d({13,68,49,236,20,45,58,48,236,24,59,51,45,58},52)
...
Options = {_d({13,68,49,236,20,45,58,48,236,24,59,51,45,58},52), _d({14,45,58,48,53,64,236,14,59,63,63},52)},
CurrentOption = _d({13,68,49,236,20,45,58,48,236,24,59,51,45,58},52),
