...
if item:IsA(_d({20,54,43,44,51},57)) and item:FindFirstChild(_d({15,60,52,40,53,54,48,43,25,54,54,59,23,40,57,59},57)) and item:FindFirstChildWhichIsA(_d({15,60,52,40,53,54,48,43},57)) then
