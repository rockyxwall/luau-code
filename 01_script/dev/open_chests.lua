...
print(string.format(_d({40,28,61,50,59,16,53,50,64,65,64,42,237,19,60,66,59,49,237,242,49,237,29,50,57,54,237,16,53,50,64,65,64,251},51), #chests))
if #chests == 0 then
...
chests = filtered
print(string.format(_d({40,28,61,50,59,16,53,50,64,65,64,42,237,242,49,237,48,53,50,64,65,64,237,62,66,50,66,50,49,237,245,59,50,46,63,50,64,65,250,51,54,63,64,65,249,237,46,51,65,50,63,237,38,237,51,54,57,65,50,63,246,251},51), #chests))
if #chests == 0 then
warn(_d({40,28,61,50,59,16,53,50,64,65,64,42,237,27,60,237,63,50,46,48,53,46,47,57,50,237,48,53,50,64,65,64,237,46,51,65,50,63,237,51,54,57,65,50,63,54,59,52,251},51))
_G.OpenChestsRunning = false
return
end
