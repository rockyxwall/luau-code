...
print(string.format(_d({37,25,58,47,56,13,50,47,61,62,61,39,234,16,57,63,56,46,234,239,46,234,26,47,54,51,234,13,50,47,61,62,61,248},54), #chests))
if #chests == 0 then
...
chests = filtered
print(string.format(_d({37,25,58,47,56,13,50,47,61,62,61,39,234,239,46,234,45,50,47,61,62,61,234,59,63,47,63,47,46,234,242,56,47,43,60,47,61,62,247,48,51,60,61,62,246,234,43,48,62,47,60,234,35,234,48,51,54,62,47,60,243,248},54), #chests))
if #chests == 0 then
