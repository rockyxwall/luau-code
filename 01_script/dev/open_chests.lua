...
print(string.format(_d({38,26,59,48,57,14,51,48,62,63,62,40,235,17,58,64,57,47,235,240,47,235,27,48,55,52,235,14,51,48,62,63,62,249},53), #chests))
if #chests == 0 then
...
chests = filtered
print(string.format(_d({38,26,59,48,57,14,51,48,62,63,62,40,235,240,47,235,46,51,48,62,63,62,235,60,64,48,64,48,47,235,243,57,48,44,61,48,62,63,248,49,52,61,62,63,247,235,44,49,63,48,61,235,36,235,49,52,55,63,48,61,244,249},53), #chests))
if #chests == 0 then
warn(_d({38,26,59,48,57,14,51,48,62,63,62,40,235,25,58,235,61,48,44,46,51,44,45,55,48,235,46,51,48,62,63,62,235,44,49,63,48,61,235,49,52,55,63,48,61,52,57,50,249},53))
_G.OpenChestsRunning = false
return
end
