...
createBtn(_d({35,74,81,64,77,251,28,61,74,81,64,251,41,64,60,77,64,78,79,251,40,74,61,10,43,71,60,84,64,77},37), UDim2.new(0, 10, 0, 65), function()
enableBot(_d({67,74,81,64,77},37))
statusLabel.Text = _d({46,79,60,79,80,78,21,251,35,74,81,64,77,68,73,66,251,12,11,9,14,251,78,79,80,63,78,251,80,75},37)
end)
createBtn(_d({31,74,63,66,64,251,30,71,68,72,61,251,3,18,11,251,78,79,80,63,78,4},37), UDim2.new(0, 10, 0, 105), function()
enableBot(_d({63,74,63,66,64},37))
statusLabel.Text = _d({46,79,60,79,80,78,21,251,31,74,63,66,64,8,67,74,71,63,68,73,66,251,3,18,11,251,78,79,80,63,78,4},37)
end)
createBtn(_d({47,64,78,79,251,46,76,80,60,77,64,251,31,74,63,66,64,251,3,15,11,251,78,79,80,63,78,4},37), UDim2.new(0, 10, 0, 145), function()
enableBot(_d({78,76,80,60,77,64,58,63,74,63,66,64},37))
statusLabel.Text = _d({46,79,60,79,80,78,21,251,46,76,80,60,77,64,251,50,60,71,70,68,73,66},37)
task.spawn(function()
local root = getRoot()
if not root then return end
...
createBtn(_d({46,47,42,43},37), UDim2.new(0, 10, 0, 185), function()
disableBot()
statusLabel.Text = _d({46,79,60,79,80,78,21,251,36,63,71,64},37)
