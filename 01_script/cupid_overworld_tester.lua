...
createBtn(_d({57,96,103,86,99,17,50,83,96,103,86,17,63,86,82,99,86,100,101,17,62,96,83,32,65,93,82,106,86,99},15), UDim2.new(0, 10, 0, 65), function()
enableBot(_d({89,96,103,86,99},15))
statusLabel.Text = _d({68,101,82,101,102,100,43,17,57,96,103,86,99,90,95,88,17,34,33,31,36,17,100,101,102,85,100,17,102,97},15)
end)
createBtn(_d({53,96,85,88,86,17,52,93,90,94,83,17,25,40,33,17,100,101,102,85,100,26},15), UDim2.new(0, 10, 0, 105), function()
enableBot(_d({85,96,85,88,86},15))
statusLabel.Text = _d({68,101,82,101,102,100,43,17,53,96,85,88,86,30,89,96,93,85,90,95,88,17,25,40,33,17,100,101,102,85,100,26},15)
end)
createBtn(_d({68,69,64,65},15), UDim2.new(0, 10, 0, 145), function()
disableBot()
statusLabel.Text = _d({68,101,82,101,102,100,43,17,58,85,93,86},15)
