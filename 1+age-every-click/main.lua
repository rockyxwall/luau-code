...
error(_d({53,29,73,71,74,59,61,78,-6,34,79,60,55,-6,32,59,67,70,63,62,-6,78,73,-6,70,73,59,62,-6,44,59,83,64,67,63,70,62,-6,47,35,-6,38,67,60,76,59,76,83,8},38))
end
local Window = Rayfield:CreateWindow({
Name = _d({29,73,71,74,59,61,78,-6,34,79,60},38),
LoadingTitle = _d({38,73,59,62,67,72,65,-6,27,79,78,73,7,29,70,67,61,69,63,76,8,8,8},38),
LoadingSubtitle = _d({41,74,78,67,71,67,84,63,62,-6,48,63,76,77,67,73,72},38),
...
Name = _d({27,79,78,73,7,32,67,76,63,-6,39,73,79,77,63,29,70,67,61,69,63,62},38),
CurrentValue = false,
...
Name = _d({29,70,67,61,69,-6,30,63,70,59,83},38),
Range = {0, 1},
Increment = 0.05,
Suffix = "s",
CurrentValue = 0.1,
...
Name = _d({30,63,77,78,76,73,83,-6,45,61,76,67,74,78},38),
Callback = function()
autoFiring = false
Rayfield:Destroy()
end,
