...
error(_d({52,28,72,70,73,58,60,77,-7,33,78,59,54,-7,31,58,66,69,62,61,-7,77,72,-7,69,72,58,61,-7,43,58,82,63,66,62,69,61,-7,46,34,-7,37,66,59,75,58,75,82,7},39))
end
local Window = Rayfield:CreateWindow({
Name = _d({28,72,70,73,58,60,77,-7,33,78,59},39),
LoadingTitle = _d({37,72,58,61,66,71,64,-7,26,78,77,72,6,28,69,66,60,68,62,75,7,7,7},39),
LoadingSubtitle = _d({40,73,77,66,70,66,83,62,61,-7,47,62,75,76,66,72,71},39),
...
Name = _d({26,78,77,72,6,31,66,75,62,-7,38,72,78,76,62,28,69,66,60,68,62,61},39),
CurrentValue = false,
...
Name = _d({28,69,66,60,68,-7,29,62,69,58,82},39),
Range = {0, 1},
Increment = 0.05,
Suffix = "s",
CurrentValue = 0.1,
...
Name = _d({29,62,76,77,75,72,82,-7,44,60,75,66,73,77},39),
Callback = function()
autoFiring = false
Rayfield:Destroy()
end,
