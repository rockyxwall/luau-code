...
if parentGui:FindFirstChild(_d({7,38,51,38,51,38,18,52,51,48,42,62,13,58,39,12,58,46},59)) then
parentGui.BananaMonkeyHubGui:Destroy()
end
local ScreenGui = Instance.new(_d({24,40,55,42,42,51,12,58,46},59))
ScreenGui.Name = _d({7,38,51,38,51,38,18,52,51,48,42,62,13,58,39,12,58,46},59)
...
ToggleBtn.Name = _d({11,49,52,38,57,46,51,44,25,52,44,44,49,42},59)
...
local toggleCorner = Instance.new(_d({26,14,8,52,55,51,42,55},59))
toggleCorner.CornerRadius = UDim.new(0.5, 0)
toggleCorner.Parent = ToggleBtn
local toggleStroke = Instance.new(_d({26,14,24,57,55,52,48,42},59))
toggleStroke.Color = Color3.fromRGB(255, 255, 255)
toggleStroke.Thickness = 2
toggleStroke.Parent = ToggleBtn
local MainFrame = Instance.new(_d({11,55,38,50,42},59))
MainFrame.Name = _d({18,38,46,51,11,55,38,50,42},59)
...
local mainCorner = Instance.new(_d({26,14,8,52,55,51,42,55},59))
mainCorner.CornerRadius = UDim.new(0, 12)
mainCorner.Parent = MainFrame
local mainStroke = Instance.new(_d({26,14,24,57,55,52,48,42},59))
mainStroke.Color = Color3.fromRGB(255, 165, 0)
mainStroke.Thickness = 1.5
mainStroke.Parent = MainFrame
local Header = Instance.new(_d({25,42,61,57,17,38,39,42,49},59))
Header.Size = UDim2.new(1, -40, 0, 36)
Header.Position = UDim2.new(0, 12, 0, 4)
Header.BackgroundTransparency = 1
Header.Text = _d({7,38,51,38,51,38,229,18,52,51,48,42,62,229,13,58,39,229,181,100,82,81},59)
Header.TextColor3 = Color3.fromRGB(255, 255, 255)
Header.TextSize = 18
Header.Font = Enum.Font.SourceSansBold
Header.TextXAlignment = Enum.TextXAlignment.Left
Header.Parent = MainFrame
local Subtitle = Instance.new(_d({25,42,61,57,17,38,39,42,49},59))
Subtitle.Size = UDim2.new(1, -40, 0, 16)
Subtitle.Position = UDim2.new(0, 12, 0, 32)
Subtitle.BackgroundTransparency = 1
Subtitle.Text = _d({6,58,57,52,242,9,42,56,57,55,52,62,241,229,15,58,50,53,229,235,229,28,38,49,48,229,6,55,52,58,51,41},59)
...
local closeCorner = Instance.new(_d({26,14,8,52,55,51,42,55},59))
...
local Divider = Instance.new(_d({11,55,38,50,42},59))
Divider.Size = UDim2.new(1, -24, 0, 1)
Divider.Position = UDim2.new(0, 12, 0, 52)
Divider.BackgroundColor3 = Color3.fromRGB(45, 45, 60)
Divider.BorderSizePixel = 0
Divider.Parent = MainFrame
local AutoBtn = Instance.new(_d({25,42,61,57,7,58,57,57,52,51},59))
AutoBtn.Size = UDim2.new(1, -24, 0, 38)
AutoBtn.Position = UDim2.new(0, 12, 0, 60)
AutoBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 52)
AutoBtn.Text = _d({6,58,57,52,242,9,42,56,57,55,52,62,229,12,55,52,58,51,41,255,229,20,11,11},59)
AutoBtn.TextColor3 = Color3.fromRGB(255, 90, 90)
AutoBtn.TextSize = 14
AutoBtn.Font = Enum.Font.SourceSansBold
AutoBtn.Parent = MainFrame
local autoCorner = Instance.new(_d({26,14,8,52,55,51,42,55},59))
autoCorner.CornerRadius = UDim.new(0, 8)
autoCorner.Parent = AutoBtn
local autoStroke = Instance.new(_d({26,14,24,57,55,52,48,42},59))
...
AutoBtn.Text = _d({6,58,57,52,242,9,42,56,57,55,52,62,229,12,55,52,58,51,41,255,229,20,19,229,167,95,102},59)
...
local JumpBtn = Instance.new(_d({25,42,61,57,7,58,57,57,52,51},59))
JumpBtn.Size = UDim2.new(1, -24, 0, 32)
JumpBtn.Position = UDim2.new(0, 12, 0, 104)
JumpBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 52)
JumpBtn.Text = _d({6,58,57,52,229,15,58,50,53,255,229,20,11,11},59)
JumpBtn.TextColor3 = Color3.fromRGB(200, 200, 200)
JumpBtn.TextSize = 13
JumpBtn.Font = Enum.Font.SourceSansBold
JumpBtn.Parent = MainFrame
local jumpCorner = Instance.new(_d({26,14,8,52,55,51,42,55},59))
jumpCorner.CornerRadius = UDim.new(0, 8)
jumpCorner.Parent = JumpBtn
local jumpStroke = Instance.new(_d({26,14,24,57,55,52,48,42},59))
...
if autoJumping then
JumpBtn.Text = _d({6,58,57,52,229,15,58,50,53,255,229,20,19,229,181,100,107,93},59)
...
local character = LocalPlayer.Character
if character then
local humanoid = character:FindFirstChildOfClass(_d({13,58,50,38,51,52,46,41},59))
if humanoid then
pcall(function()
...
local MoveBtn = Instance.new(_d({25,42,61,57,7,58,57,57,52,51},59))
MoveBtn.Size = UDim2.new(1, -24, 0, 32)
MoveBtn.Position = UDim2.new(0, 12, 0, 142)
MoveBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 52)
MoveBtn.Text = _d({6,58,57,52,242,18,52,59,42,229,237,28,38,49,48,229,6,55,52,58,51,41,238,255,229,20,11,11},59)
MoveBtn.TextColor3 = Color3.fromRGB(200, 200, 200)
MoveBtn.TextSize = 13
MoveBtn.Font = Enum.Font.SourceSansBold
MoveBtn.Parent = MainFrame
local moveCorner = Instance.new(_d({26,14,8,52,55,51,42,55},59))
moveCorner.CornerRadius = UDim.new(0, 8)
moveCorner.Parent = MoveBtn
local moveStroke = Instance.new(_d({26,14,24,57,55,52,48,42},59))
...
if autoMoving then
MoveBtn.Text = _d({6,58,57,52,242,18,52,59,42,229,237,28,38,49,48,229,6,55,52,58,51,41,238,255,229,20,19,229,181,100,95,123},59)
...
local SpeedLabel = Instance.new(_d({25,42,61,57,17,38,39,42,49},59))
SpeedLabel.Size = UDim2.new(1, -24, 0, 18)
SpeedLabel.Position = UDim2.new(0, 12, 0, 180)
SpeedLabel.BackgroundTransparency = 1
SpeedLabel.Text = _d({21,58,51,40,45,229,9,42,49,38,62,255,229,245,243,246,245,56,229,237,11,38,56,57,238},59)
SpeedLabel.TextColor3 = Color3.fromRGB(200, 200, 220)
SpeedLabel.TextSize = 12
SpeedLabel.Font = Enum.Font.SourceSans
SpeedLabel.TextXAlignment = Enum.TextXAlignment.Left
SpeedLabel.Parent = MainFrame
local speedContainer = Instance.new(_d({11,55,38,50,42},59))
speedContainer.Size = UDim2.new(1, -24, 0, 28)
speedContainer.Position = UDim2.new(0, 12, 0, 200)
speedContainer.BackgroundTransparency = 1
speedContainer.Parent = MainFrame
local speeds = {
{ label = _d({245,243,245,250,56},59), delay = 0.05 },
{ label = _d({245,243,246,245,56},59), delay = 0.10 },
{ label = _d({245,243,247,250,56},59), delay = 0.25 },
{ label = _d({245,243,250,245,56},59), delay = 0.50 }
}
...
SpeedLabel.Text = _d({21,58,51,40,45,229,9,42,49,38,62,255,229},59) .. string.format(_d({234,243,247,43,56},59), destroyDelay)
for _, child in ipairs(speedContainer:GetChildren()) do
if child:IsA(_d({25,42,61,57,7,58,57,57,52,51},59)) then
...
local DestroyBtn = Instance.new(_d({25,42,61,57,7,58,57,57,52,51},59))
...
DestroyBtn.Text = _d({26,51,49,52,38,41,229,13,58,39,229,24,40,55,46,53,57},59)
DestroyBtn.TextColor3 = Color3.fromRGB(255, 120, 120)
DestroyBtn.TextSize = 12
DestroyBtn.Font = Enum.Font.SourceSans
DestroyBtn.Parent = MainFrame
local destroyCorner = Instance.new(_d({26,14,8,52,55,51,42,55},59))
...
print(_d({32,7,38,51,38,51,38,229,18,52,51,48,42,62,229,13,58,39,34,229,17,52,38,41,42,41,229,56,58,40,40,42,56,56,43,58,49,49,62,230},59))
end)()