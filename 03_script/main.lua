...
if parentGui:FindFirstChild(_d({28,59,72,59,72,59,39,73,72,69,63,83,34,79,60,33,79,67},38)) then
parentGui.BananaMonkeyHubGui:Destroy()
end
local ScreenGui = Instance.new(_d({45,61,76,63,63,72,33,79,67},38))
ScreenGui.Name = _d({28,59,72,59,72,59,39,73,72,69,63,83,34,79,60,33,79,67},38)
...
local ToggleBtn = Instance.new(_d({46,63,82,78,28,79,78,78,73,72},38))
ToggleBtn.Name = _d({32,70,73,59,78,67,72,65,46,73,65,65,70,63},38)
ToggleBtn.Size = UDim2.new(0, 50, 0, 50)
ToggleBtn.Position = UDim2.new(0.03, 0, 0.25, 0)
ToggleBtn.BackgroundColor3 = Color3.fromRGB(255, 165, 0)
ToggleBtn.Text = _d({202,121,103,102},38)
...
local toggleCorner = Instance.new(_d({47,35,29,73,76,72,63,76},38))
toggleCorner.CornerRadius = UDim.new(0.5, 0)
toggleCorner.Parent = ToggleBtn
local toggleStroke = Instance.new(_d({47,35,45,78,76,73,69,63},38))
toggleStroke.Color = Color3.fromRGB(255, 255, 255)
toggleStroke.Thickness = 2
toggleStroke.Parent = ToggleBtn
local MainFrame = Instance.new(_d({32,76,59,71,63},38))
MainFrame.Name = _d({39,59,67,72,32,76,59,71,63},38)
...
local mainCorner = Instance.new(_d({47,35,29,73,76,72,63,76},38))
mainCorner.CornerRadius = UDim.new(0, 12)
mainCorner.Parent = MainFrame
local mainStroke = Instance.new(_d({47,35,45,78,76,73,69,63},38))
mainStroke.Color = Color3.fromRGB(255, 165, 0)
mainStroke.Thickness = 1.5
mainStroke.Parent = MainFrame
local Header = Instance.new(_d({46,63,82,78,38,59,60,63,70},38))
Header.Size = UDim2.new(1, -40, 0, 36)
Header.Position = UDim2.new(0, 12, 0, 4)
Header.BackgroundTransparency = 1
Header.Text = _d({28,59,72,59,72,59,250,39,73,72,69,63,83,250,34,79,60,250,202,121,103,102},38)
Header.TextColor3 = Color3.fromRGB(255, 255, 255)
Header.TextSize = 18
Header.Font = Enum.Font.SourceSansBold
Header.TextXAlignment = Enum.TextXAlignment.Left
Header.Parent = MainFrame
local Subtitle = Instance.new(_d({46,63,82,78,38,59,60,63,70},38))
Subtitle.Size = UDim2.new(1, -40, 0, 16)
Subtitle.Position = UDim2.new(0, 12, 0, 32)
Subtitle.BackgroundTransparency = 1
Subtitle.Text = _d({27,79,78,73,7,30,63,77,78,76,73,83,6,250,36,79,71,74,250,0,250,49,59,70,69,250,27,76,73,79,72,62},38)
Subtitle.TextColor3 = Color3.fromRGB(160, 160, 180)
Subtitle.TextSize = 12
Subtitle.Font = Enum.Font.SourceSans
Subtitle.TextXAlignment = Enum.TextXAlignment.Left
Subtitle.Parent = MainFrame
local CloseBtn = Instance.new(_d({46,63,82,78,28,79,78,78,73,72},38))
...
local closeCorner = Instance.new(_d({47,35,29,73,76,72,63,76},38))
...
local Divider = Instance.new(_d({32,76,59,71,63},38))
Divider.Size = UDim2.new(1, -24, 0, 1)
Divider.Position = UDim2.new(0, 12, 0, 52)
Divider.BackgroundColor3 = Color3.fromRGB(45, 45, 60)
Divider.BorderSizePixel = 0
Divider.Parent = MainFrame
local AutoBtn = Instance.new(_d({46,63,82,78,28,79,78,78,73,72},38))
AutoBtn.Size = UDim2.new(1, -24, 0, 38)
AutoBtn.Position = UDim2.new(0, 12, 0, 60)
AutoBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 52)
AutoBtn.Text = _d({27,79,78,73,7,30,63,77,78,76,73,83,250,33,76,73,79,72,62,20,250,41,32,32},38)
AutoBtn.TextColor3 = Color3.fromRGB(255, 90, 90)
AutoBtn.TextSize = 14
AutoBtn.Font = Enum.Font.SourceSansBold
AutoBtn.Parent = MainFrame
local autoCorner = Instance.new(_d({47,35,29,73,76,72,63,76},38))
autoCorner.CornerRadius = UDim.new(0, 8)
autoCorner.Parent = AutoBtn
local autoStroke = Instance.new(_d({47,35,45,78,76,73,69,63},38))
...
AutoBtn.Text = _d({27,79,78,73,7,30,63,77,78,76,73,83,250,33,76,73,79,72,62,20,250,41,40,250,188,116,123},38)
...
if character then
local root = character:FindFirstChild(_d({34,79,71,59,72,73,67,62,44,73,73,78,42,59,76,78},38))
if root then
local punchEvent = ReplicatedStorage:FindFirstChild(_d({30,63,77,78,76,79,61,78,67,73,72,57,42,79,72,61,66},38), true)
if punchEvent and punchEvent:IsA(_d({44,63,71,73,78,63,31,80,63,72,78},38)) then
...
local JumpBtn = Instance.new(_d({46,63,82,78,28,79,78,78,73,72},38))
JumpBtn.Size = UDim2.new(1, -24, 0, 32)
JumpBtn.Position = UDim2.new(0, 12, 0, 104)
JumpBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 52)
JumpBtn.Text = _d({27,79,78,73,250,36,79,71,74,20,250,41,32,32},38)
JumpBtn.TextColor3 = Color3.fromRGB(200, 200, 200)
JumpBtn.TextSize = 13
JumpBtn.Font = Enum.Font.SourceSansBold
JumpBtn.Parent = MainFrame
local jumpCorner = Instance.new(_d({47,35,29,73,76,72,63,76},38))
jumpCorner.CornerRadius = UDim.new(0, 8)
jumpCorner.Parent = JumpBtn
local jumpStroke = Instance.new(_d({47,35,45,78,76,73,69,63},38))
...
if autoJumping then
JumpBtn.Text = _d({27,79,78,73,250,36,79,71,74,20,250,41,40,250,202,121,128,114},38)
...
local character = LocalPlayer.Character
if character then
local humanoid = character:FindFirstChildOfClass(_d({34,79,71,59,72,73,67,62},38))
if humanoid then
pcall(function()
...
if autoMoving then
MoveBtn.Text = _d({27,79,78,73,7,39,73,80,63,250,2,49,59,70,69,250,27,76,73,79,72,62,3,20,250,41,40,250,202,121,116,144},38)
...
local SpeedLabel = Instance.new(_d({46,63,82,78,38,59,60,63,70},38))
SpeedLabel.Size = UDim2.new(1, -24, 0, 18)
SpeedLabel.Position = UDim2.new(0, 12, 0, 180)
SpeedLabel.BackgroundTransparency = 1
SpeedLabel.Text = _d({42,79,72,61,66,250,30,63,70,59,83,20,250,10,8,11,10,77,250,2,32,59,77,78,3},38)
SpeedLabel.TextColor3 = Color3.fromRGB(200, 200, 220)
SpeedLabel.TextSize = 12
SpeedLabel.Font = Enum.Font.SourceSans
SpeedLabel.TextXAlignment = Enum.TextXAlignment.Left
SpeedLabel.Parent = MainFrame
local speedContainer = Instance.new(_d({32,76,59,71,63},38))
speedContainer.Size = UDim2.new(1, -24, 0, 28)
speedContainer.Position = UDim2.new(0, 12, 0, 200)
speedContainer.BackgroundTransparency = 1
speedContainer.Parent = MainFrame
local speeds = {
{ label = _d({10,8,10,15,77},38), delay = 0.05 },
{ label = _d({10,8,11,10,77},38), delay = 0.10 },
{ label = _d({10,8,12,15,77},38), delay = 0.25 },
{ label = _d({10,8,15,10,77},38), delay = 0.50 }
}
...
SpeedLabel.Text = _d({42,79,72,61,66,250,30,63,70,59,83,20,250},38) .. string.format(_d({255,8,12,64,77},38), destroyDelay)
for _, child in ipairs(speedContainer:GetChildren()) do
if child:IsA(_d({46,63,82,78,28,79,78,78,73,72},38)) then
...
local DestroyBtn = Instance.new(_d({46,63,82,78,28,79,78,78,73,72},38))
...
DestroyBtn.Text = _d({47,72,70,73,59,62,250,34,79,60,250,45,61,76,67,74,78},38)
DestroyBtn.TextColor3 = Color3.fromRGB(255, 120, 120)
DestroyBtn.TextSize = 12
DestroyBtn.Font = Enum.Font.SourceSans
DestroyBtn.Parent = MainFrame
local destroyCorner = Instance.new(_d({47,35,29,73,76,72,63,76},38))
...
print(_d({53,28,59,72,59,72,59,250,39,73,72,69,63,83,250,34,79,60,55,250,38,73,59,62,63,62,250,77,79,61,61,63,77,77,64,79,70,70,83,251},38))
end)()