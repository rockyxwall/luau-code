...
if parentGui:FindFirstChild(_d({23,54,67,54,67,54,34,68,67,64,58,78,29,74,55,28,74,62},43)) then
parentGui.BananaMonkeyHubGui:Destroy()
end
local ScreenGui = Instance.new(_d({40,56,71,58,58,67,28,74,62},43))
ScreenGui.Name = _d({23,54,67,54,67,54,34,68,67,64,58,78,29,74,55,28,74,62},43)
...
local ToggleBtn = Instance.new(_d({41,58,77,73,23,74,73,73,68,67},43))
ToggleBtn.Name = _d({27,65,68,54,73,62,67,60,41,68,60,60,65,58},43)
ToggleBtn.Size = UDim2.new(0, 50, 0, 50)
ToggleBtn.Position = UDim2.new(0.03, 0, 0.25, 0)
ToggleBtn.BackgroundColor3 = Color3.fromRGB(255, 165, 0)
ToggleBtn.Text = _d({197,116,98,97},43)
...
local toggleCorner = Instance.new(_d({42,30,24,68,71,67,58,71},43))
toggleCorner.CornerRadius = UDim.new(0.5, 0)
toggleCorner.Parent = ToggleBtn
local toggleStroke = Instance.new(_d({42,30,40,73,71,68,64,58},43))
toggleStroke.Color = Color3.fromRGB(255, 255, 255)
toggleStroke.Thickness = 2
toggleStroke.Parent = ToggleBtn
local MainFrame = Instance.new(_d({27,71,54,66,58},43))
MainFrame.Name = _d({34,54,62,67,27,71,54,66,58},43)
...
local mainCorner = Instance.new(_d({42,30,24,68,71,67,58,71},43))
mainCorner.CornerRadius = UDim.new(0, 12)
mainCorner.Parent = MainFrame
local mainStroke = Instance.new(_d({42,30,40,73,71,68,64,58},43))
mainStroke.Color = Color3.fromRGB(255, 165, 0)
mainStroke.Thickness = 1.5
mainStroke.Parent = MainFrame
local Header = Instance.new(_d({41,58,77,73,33,54,55,58,65},43))
Header.Size = UDim2.new(1, -40, 0, 36)
Header.Position = UDim2.new(0, 12, 0, 4)
Header.BackgroundTransparency = 1
Header.Text = _d({23,54,67,54,67,54,245,34,68,67,64,58,78,245,29,74,55,245,197,116,98,97},43)
Header.TextColor3 = Color3.fromRGB(255, 255, 255)
Header.TextSize = 18
Header.Font = Enum.Font.SourceSansBold
Header.TextXAlignment = Enum.TextXAlignment.Left
Header.Parent = MainFrame
local Subtitle = Instance.new(_d({41,58,77,73,33,54,55,58,65},43))
Subtitle.Size = UDim2.new(1, -40, 0, 16)
Subtitle.Position = UDim2.new(0, 12, 0, 32)
Subtitle.BackgroundTransparency = 1
Subtitle.Text = _d({22,74,73,68,2,25,58,72,73,71,68,78,1,245,31,74,66,69,245,251,245,44,54,65,64,245,22,71,68,74,67,57},43)
...
local closeCorner = Instance.new(_d({42,30,24,68,71,67,58,71},43))
...
local Divider = Instance.new(_d({27,71,54,66,58},43))
Divider.Size = UDim2.new(1, -24, 0, 1)
Divider.Position = UDim2.new(0, 12, 0, 52)
Divider.BackgroundColor3 = Color3.fromRGB(45, 45, 60)
Divider.BorderSizePixel = 0
Divider.Parent = MainFrame
local AutoBtn = Instance.new(_d({41,58,77,73,23,74,73,73,68,67},43))
AutoBtn.Size = UDim2.new(1, -24, 0, 38)
AutoBtn.Position = UDim2.new(0, 12, 0, 60)
AutoBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 52)
AutoBtn.Text = _d({22,74,73,68,2,25,58,72,73,71,68,78,245,28,71,68,74,67,57,15,245,36,27,27},43)
AutoBtn.TextColor3 = Color3.fromRGB(255, 90, 90)
AutoBtn.TextSize = 14
AutoBtn.Font = Enum.Font.SourceSansBold
AutoBtn.Parent = MainFrame
local autoCorner = Instance.new(_d({42,30,24,68,71,67,58,71},43))
autoCorner.CornerRadius = UDim.new(0, 8)
autoCorner.Parent = AutoBtn
local autoStroke = Instance.new(_d({42,30,40,73,71,68,64,58},43))
...
AutoBtn.Text = _d({22,74,73,68,2,25,58,72,73,71,68,78,245,28,71,68,74,67,57,15,245,36,35,245,183,111,118},43)
...
if character then
local root = character:FindFirstChild(_d({29,74,66,54,67,68,62,57,39,68,68,73,37,54,71,73},43))
if root then
local punchEvent = ReplicatedStorage:FindFirstChild(_d({25,58,72,73,71,74,56,73,62,68,67,52,37,74,67,56,61},43), true)
if punchEvent and punchEvent:IsA(_d({39,58,66,68,73,58,26,75,58,67,73},43)) then
...
local JumpBtn = Instance.new(_d({41,58,77,73,23,74,73,73,68,67},43))
JumpBtn.Size = UDim2.new(1, -24, 0, 32)
JumpBtn.Position = UDim2.new(0, 12, 0, 104)
JumpBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 52)
JumpBtn.Text = _d({22,74,73,68,245,31,74,66,69,15,245,36,27,27},43)
JumpBtn.TextColor3 = Color3.fromRGB(200, 200, 200)
JumpBtn.TextSize = 13
JumpBtn.Font = Enum.Font.SourceSansBold
JumpBtn.Parent = MainFrame
local jumpCorner = Instance.new(_d({42,30,24,68,71,67,58,71},43))
jumpCorner.CornerRadius = UDim.new(0, 8)
jumpCorner.Parent = JumpBtn
local jumpStroke = Instance.new(_d({42,30,40,73,71,68,64,58},43))
...
if autoJumping then
JumpBtn.Text = _d({22,74,73,68,245,31,74,66,69,15,245,36,35,245,197,116,123,109},43)
...
local character = LocalPlayer.Character
if character then
local humanoid = character:FindFirstChildOfClass(_d({29,74,66,54,67,68,62,57},43))
if humanoid then
pcall(function()
...
local MoveBtn = Instance.new(_d({41,58,77,73,23,74,73,73,68,67},43))
MoveBtn.Size = UDim2.new(1, -24, 0, 32)
MoveBtn.Position = UDim2.new(0, 12, 0, 142)
MoveBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 52)
MoveBtn.Text = _d({22,74,73,68,2,34,68,75,58,245,253,44,54,65,64,245,22,71,68,74,67,57,254,15,245,36,27,27},43)
MoveBtn.TextColor3 = Color3.fromRGB(200, 200, 200)
MoveBtn.TextSize = 13
MoveBtn.Font = Enum.Font.SourceSansBold
MoveBtn.Parent = MainFrame
local moveCorner = Instance.new(_d({42,30,24,68,71,67,58,71},43))
moveCorner.CornerRadius = UDim.new(0, 8)
moveCorner.Parent = MoveBtn
local moveStroke = Instance.new(_d({42,30,40,73,71,68,64,58},43))
...
if autoMoving then
MoveBtn.Text = _d({22,74,73,68,2,34,68,75,58,245,253,44,54,65,64,245,22,71,68,74,67,57,254,15,245,36,35,245,197,116,111,139},43)
...
local SpeedLabel = Instance.new(_d({41,58,77,73,33,54,55,58,65},43))
SpeedLabel.Size = UDim2.new(1, -24, 0, 18)
SpeedLabel.Position = UDim2.new(0, 12, 0, 180)
SpeedLabel.BackgroundTransparency = 1
SpeedLabel.Text = _d({37,74,67,56,61,245,25,58,65,54,78,15,245,5,3,6,5,72,245,253,27,54,72,73,254},43)
SpeedLabel.TextColor3 = Color3.fromRGB(200, 200, 220)
SpeedLabel.TextSize = 12
SpeedLabel.Font = Enum.Font.SourceSans
SpeedLabel.TextXAlignment = Enum.TextXAlignment.Left
SpeedLabel.Parent = MainFrame
local speedContainer = Instance.new(_d({27,71,54,66,58},43))
speedContainer.Size = UDim2.new(1, -24, 0, 28)
speedContainer.Position = UDim2.new(0, 12, 0, 200)
speedContainer.BackgroundTransparency = 1
speedContainer.Parent = MainFrame
local speeds = {
{ label = _d({5,3,5,10,72},43), delay = 0.05 },
{ label = _d({5,3,6,5,72},43), delay = 0.10 },
{ label = _d({5,3,7,10,72},43), delay = 0.25 },
{ label = _d({5,3,10,5,72},43), delay = 0.50 }
}
...
SpeedLabel.Text = _d({37,74,67,56,61,245,25,58,65,54,78,15,245},43) .. string.format(_d({250,3,7,59,72},43), destroyDelay)
for _, child in ipairs(speedContainer:GetChildren()) do
if child:IsA(_d({41,58,77,73,23,74,73,73,68,67},43)) then
...
local DestroyBtn = Instance.new(_d({41,58,77,73,23,74,73,73,68,67},43))
...
DestroyBtn.Text = _d({42,67,65,68,54,57,245,29,74,55,245,40,56,71,62,69,73},43)
DestroyBtn.TextColor3 = Color3.fromRGB(255, 120, 120)
DestroyBtn.TextSize = 12
DestroyBtn.Font = Enum.Font.SourceSans
DestroyBtn.Parent = MainFrame
local destroyCorner = Instance.new(_d({42,30,24,68,71,67,58,71},43))
...
print(_d({48,23,54,67,54,67,54,245,34,68,67,64,58,78,245,29,74,55,50,245,33,68,54,57,58,57,245,72,74,56,56,58,72,72,59,74,65,65,78,246},43))
end)()