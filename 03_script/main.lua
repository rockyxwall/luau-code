...
Subtitle.Text = _d({44,96,95,90,24,47,80,94,95,93,90,100,23,11,53,96,88,91,11,17,11,66,76,87,86,11,44,93,90,96,89,79},21)
...
local JumpBtn = Instance.new(_d({63,80,99,95,45,96,95,95,90,89},21))
JumpBtn.Size = UDim2.new(1, -24, 0, 32)
JumpBtn.Position = UDim2.new(0, 12, 0, 104)
JumpBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 52)
JumpBtn.Text = _d({44,96,95,90,11,53,96,88,91,37,11,58,49,49},21)
JumpBtn.TextColor3 = Color3.fromRGB(200, 200, 200)
JumpBtn.TextSize = 13
JumpBtn.Font = Enum.Font.SourceSansBold
JumpBtn.Parent = MainFrame
local jumpCorner = Instance.new(_d({64,52,46,90,93,89,80,93},21))
jumpCorner.CornerRadius = UDim.new(0, 8)
jumpCorner.Parent = JumpBtn
local jumpStroke = Instance.new(_d({64,52,62,95,93,90,86,80},21))
...
if autoJumping then
JumpBtn.Text = _d({44,96,95,90,11,53,96,88,91,37,11,58,57,11,219,138,145,131},21)
...
local character = LocalPlayer.Character
if character then
local humanoid = character:FindFirstChildOfClass(_d({51,96,88,76,89,90,84,79},21))
if humanoid then
pcall(function()
...
if autoMoving then
MoveBtn.Text = _d({44,96,95,90,24,56,90,97,80,11,19,66,76,87,86,11,44,93,90,96,89,79,20,37,11,58,57,11,219,138,133,161},21)
